...
ℹ 首先插播一下，我在网站更新了Reference List + 功能，就在右上角↗。
...
<br>
    ...
    这周终于要写代码了。
    好像也没必要设deadline，毕竟真干起活来激发潜能一周能啃八周的量。
    比如上周大概半小时不到的内容，放在这周开写之前弄一下就行了（大概？）。
...
> 在我构思这周的文章内容的时候，我发现这个系列做成Hybrid DevLog（名字乱起）的形式可能更方便一些，除开单纯的Tutorial，加上DevLog的内容可以在思考问题的时候随时记录心流，省的出现“刚想到了个点子现在没了”这样的尴尬情况。<br>与单纯的Sticky Notes相比大概是进阶版？强迫自己抽出一整段时间思考，然后把碎片化的想法整理起来。而且之后补文档的时候可以直接从里面偷（）<br> 以上废话
...
[<img width="740px" src="/assets/timeline.jpg">](/assets/timeline.jpg)
...
⚠ 这部分内容同样不是最终版，要达成设计流程肯定还要加点什么，具体写代码的时候得随机应变。
稍微有点挑战性才有趣（？
...
[<img class="primary" src="/assets/class-diagram.jpg">](/assets/class-diagram.jpg)
